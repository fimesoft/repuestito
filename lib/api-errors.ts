...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  TENANT_TAX_ID_TAKEN: 'Ya existe un local registrado con ese documento',
  TENANT_TAX_ID_INVALID: 'El número de documento no tiene un formato válido',
  TENANT_DOCUMENT_TYPE_INVALID: 'El tipo de documento no es válido para el país elegido',
  TENANT_NAME_TAKEN: 'Ya existe un local con ese nombre',
  TENANT_NAME_TOO_SHORT: 'El nombre del local debe tener al menos 3 letras o números',
  TENANT_NAME_RESERVED: 'Ese nombre de local no está disponible',
  TENANT_OWNER_REQUIRED: 'Ingresá tu nombre y apellido',
